...
const services = [
  {
    icon: <GrUserWorker className="text-5xl text-amber-700 mx-auto" />,
    ...
    <section id="servicios" className="container mx-auto px-4 py-12">
      ...
      <div className="flex flex-wrap justify-center gap-6 py-20">
        {services.map((service, index) => (
          <div
            key={index}
            className="bg-white shadow-md hover:shadow-lg transition-shadow duration-300 rounded-lg p-6 sm:w-[45%] lg:w-[22%] text-center flex flex-col items-center"
          >
            {service.icon}
            <h4 className="text-xl font-bold py-4">{service.title}</h4>
